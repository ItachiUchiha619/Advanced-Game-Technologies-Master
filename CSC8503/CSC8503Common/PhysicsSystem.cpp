		...
		for (auto j = i + 1; j != last; ++j) {
			...
			if (CollisionDetection::ObjectIntersection(*i, *j, info)) {
				...
				if (info.a->GetPhysicsObject()->GetCollisionResponces() == true && info.b->GetPhysicsObject()->GetCollisionResponces() == true) {
					...
					if ((info.a->GetName() == "MazeGoal" && info.b->GetName() == "EnemySphere" || (info.b->GetName() == "MazeGoal" && info.a->GetName() == "EnemySphere"))) {
						SetCatchState(true);
					}
					if ((info.a->GetName() == "Player1" && info.b->GetName() == "MazeGoal" || (info.b->GetName() == "Player1" && info.a->GetName() == "MazeGoal"))) {
